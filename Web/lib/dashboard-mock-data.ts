...
export const GUARDIAN_NODES = [
  {
    ...
    ensLink: "https://sepolia.app.ens.domains/guardian-1.guardmesh.eth",
  ...
  },
  {
    ...
    ensLink: "https://sepolia.app.ens.domains/guardian-2.guardmesh.eth",
    model: "qwen-2.5-7b-instruct (TeeML)",
    status: "online" as const,
    votes: 1198,
    uptime: "98.7%",
  ...
  },
  {
    ...
    ensLink: "https://sepolia.app.ens.domains/guardian-3.guardmesh.eth",
    model: "qwen-2.5-7b-instruct (TeeML)",
    status: "online" as const,
    votes: 1201,
    uptime: "99.0%",
