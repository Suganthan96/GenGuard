...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the Genguard SDK" },
      { type: "command", text: "npm install @genguard/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx genguard init" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@genguard/sdk'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@genguard/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Deploy to Genguard Cloud" },
      { type: "command", text: "genguard deploy --prod" },
      { type: "gap" },
      ...
      { type: "url", text: "  -> https://agents.genguard.dev/researcher" },
    ],
  },
]
